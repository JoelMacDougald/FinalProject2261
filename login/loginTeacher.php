...
if (isset($_SESSION["loggedIn"]) && $_SESSION["loggedIn"]) {
    ...
    header("location:../indexMain/indexTeacher.php");
    exit;
}
if (!isset($_POST['submit'])) {
    ...
    <div class="login-form">
        <form action="<?php echo htmlspecialchars(basename($_SERVER['REQUEST_URI'])); ?>" method="post">
            ...
            <div class="form-group">
                <input type="text" name="teacherId" class="form-control" placeholder="TeacherId" required="required">
            </div>
             <div class="form-group">
    ...
    $teacherId = $mysqli->real_escape_string($_POST['teacherId']);
    ...
    $query = "SELECT * FROM teachers WHERE BINARY teacherId = '" . $teacherId . "' AND pass = SHA1('" . $password . "')";
